...
# def SoftMax_bias_CB_loss(input, label, samples_per_cls, no_of_classes, loss_type, beta, gamma, device):
...
def CB_loss(labels, logits, samples_per_cls, no_of_classes, loss_type, beta, gamma, device):
    ...
    if loss_type == "focal":
        ...
        n_loss = torch.log(1 + torch.exp( logits))
...
if __name__ == '__main__':
    ...
    loss_type = "focal"
    cb_loss = CB_loss(labels, logits, samples_per_cls, no_of_classes,loss_type, beta, gamma, device="cpu")
    print(cb_loss)
